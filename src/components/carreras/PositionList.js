...
function PositionList(){
    return(
        <div className="mx-12 max-w-full py-16 bg-white">
            <h2 className="mx-auto lg:mx-12 text-5xl text-gray-900 font-semibold pb-8">Open Positions</h2>
            <p className="text-2xl leading-10 text-gray-800  max-w-4xl">Let's write some beautiful code and make smart designs. This is what we're crazy about, and we're looking for the ones who feel the same.</p>
            <div>
