  ...
  return (
    <div className="bg-white">
      <div className="mx-auto lg:mx-12 max-w-full py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div className="mx-12 max-w-full text-left">
          <h2 className="text-5xl font-semibold tracking-tight text-black">All-in-one <span className='text-orange-button'>platform</span></h2>
          <p className="my-16  max-w-3xl text-2xl leading-10 text-gray-800">
          There are some things we velue in our people. And what we expect from new people as well.
          </p>
        </div>
        <dl className="mt-12 mx-12 space-y-10 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:grid-cols-3 lg:gap-x-8">
