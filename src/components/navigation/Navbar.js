    ...
    return(
        <nav id='navbar' className='w-full py-4 top-0 transition duration-300 ease-in-out z-40 fixed'>
            <div className=" px-4 sm:px-6">
                <div className="hidden -ml-4 -mt-2 lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                ...
                <div className=" lg:hidden -ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                    <Link to='/' className="ml-4 mt-2">
                        <img 
                        src={toronto_logo}
                        width={140}
